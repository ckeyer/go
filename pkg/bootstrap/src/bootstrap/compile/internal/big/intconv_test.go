// Do not edit. Bootstrap copy of /usr/local/go/src/cmd/compile/internal/big/intconv_test.go

//line /usr/local/go/src/cmd/compile/internal/big/intconv_test.go:1
