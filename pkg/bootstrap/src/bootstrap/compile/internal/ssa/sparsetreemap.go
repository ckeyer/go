// Do not edit. Bootstrap copy of /usr/local/go/src/cmd/compile/internal/ssa/sparsetreemap.go

//line /usr/local/go/src/cmd/compile/internal/ssa/sparsetreemap.go:1
