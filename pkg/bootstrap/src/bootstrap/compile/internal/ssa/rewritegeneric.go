// Do not edit. Bootstrap copy of /usr/local/go/src/cmd/compile/internal/ssa/rewritegeneric.go

//line /usr/local/go/src/cmd/compile/internal/ssa/rewritegeneric.go:1
