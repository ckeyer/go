// Do not edit. Bootstrap copy of /usr/local/go/src/cmd/compile/internal/ssa/nilcheck_test.go

//line /usr/local/go/src/cmd/compile/internal/ssa/nilcheck_test.go:1
package ssa
