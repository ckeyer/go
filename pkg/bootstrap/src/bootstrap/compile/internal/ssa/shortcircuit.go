// Do not edit. Bootstrap copy of /usr/local/go/src/cmd/compile/internal/ssa/shortcircuit.go

//line /usr/local/go/src/cmd/compile/internal/ssa/shortcircuit.go:1
