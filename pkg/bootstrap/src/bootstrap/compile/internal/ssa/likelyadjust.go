// Do not edit. Bootstrap copy of /usr/local/go/src/cmd/compile/internal/ssa/likelyadjust.go

//line /usr/local/go/src/cmd/compile/internal/ssa/likelyadjust.go:1
