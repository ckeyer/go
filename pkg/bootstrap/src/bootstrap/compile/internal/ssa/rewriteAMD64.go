// Do not edit. Bootstrap copy of /usr/local/go/src/cmd/compile/internal/ssa/rewriteAMD64.go

//line /usr/local/go/src/cmd/compile/internal/ssa/rewriteAMD64.go:1
