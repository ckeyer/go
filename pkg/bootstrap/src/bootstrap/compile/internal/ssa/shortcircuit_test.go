// Do not edit. Bootstrap copy of /usr/local/go/src/cmd/compile/internal/ssa/shortcircuit_test.go

//line /usr/local/go/src/cmd/compile/internal/ssa/shortcircuit_test.go:1
