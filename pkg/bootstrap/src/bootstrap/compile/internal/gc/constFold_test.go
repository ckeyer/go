// Do not edit. Bootstrap copy of /usr/local/go/src/cmd/compile/internal/gc/constFold_test.go

//line /usr/local/go/src/cmd/compile/internal/gc/constFold_test.go:1
package gc
