// Do not edit. Bootstrap copy of /usr/local/go/src/cmd/compile/internal/gc/sparselocatephifunctions.go

//line /usr/local/go/src/cmd/compile/internal/gc/sparselocatephifunctions.go:1
