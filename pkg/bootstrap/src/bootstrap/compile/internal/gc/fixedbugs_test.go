// Do not edit. Bootstrap copy of /usr/local/go/src/cmd/compile/internal/gc/fixedbugs_test.go

//line /usr/local/go/src/cmd/compile/internal/gc/fixedbugs_test.go:1
